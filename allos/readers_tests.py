...
# %% ../nbs/003_readers_tests.ipynb #initial_id
import urllib
...
# %% ../nbs/003_readers_tests.ipynb #73aab0a2
from pathlib import Path
import os
import pandas as pd
...
# %% ../nbs/003_readers_tests.ipynb #f64d693233b5eb25
from pathlib import Path
import urllib.request
import gzip
import shutil
...
# %% ../nbs/003_readers_tests.ipynb #b2ca3b33
import os
import pandas as pd
import scanpy as sc
...
# %% ../nbs/003_readers_tests.ipynb #ba5425abdee359fd
import pandas as pd
import warnings
...
# %% ../nbs/003_readers_tests.ipynb #612df976
def process_mouse_data():
    ...
    df_filtered = df_filtered.set_index('barcode')
